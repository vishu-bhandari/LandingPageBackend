...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      imageUrl:
        "https://i.postimg.cc/yNpTDxhG/Whats-App-Image-2024-08-17-at-16-43-44.jpg",
      description:
        "Thank you so much for providing us with such informative sessions that are helping us to mold ourselves with confidence. Every nitty gritty is contributing for our betterment and extricate ourselves from being trapped into the thought of being judged by people.🤩💫Its being a great experience",
    },
    {
      name: "Ashok",
      lname: "Chaudhary",
      position: "Teacher",
      imageUrl:
        "https://i.postimg.cc/9MSQqGc7/Whats-App-Image-2024-07-17-at-13-52-06.jpg",
      description:
        "I have experienced that as many times I took the class many more new aspects learned. Truly every session was amazing.",
    },
    {
      name: "Ankur",
      lname: "Gupta",
      ...
      description:
        "It was a great journey. I learned about intricacies of public speaking, activities which can enhance my skills and structure my content and target my audience. It's overall a great session.",
    },
    {
      name: "Atul",
      lname: "Vij",
      ...
      description:
        "Says things politely but does not dilute the content. Good memory to cite past incidents too.",
    },
    {
    ...
    },
    {
      ...
      imageUrl:
        "https://i.postimg.cc/QNqFgSjH/Rajinder-Popli-Pic-jpeg-Intro-Social-Worker-Trainer.jpg",
      description:
        "It was really quite effective and useful to speak on a wide range of topics. The current storytelling is a wonderful way to sharpen our narrative skills and stimulate our thinking. Wonderful",
    },
    {
      name: "Amit",
      lname: "Upadhyay",
    ...
    },
    {
      ...
      description:
        "The sessions of public speaking with coach Sushant Singhal have been really insightful. The topics are extremely well explained and detailed planned in such a way that leaves no room for doubts. I am glad that I am associated with him and get to have wonderful discussions about public speaking and life with him in his sessions.",
    },
  ];
      ...
      <div className="container mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
          <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="md:mt-4 mt-0 text-gray-400 md:text-left text-center">
              TESTIMONIALS
            </p>
          ...
          <div className="-mx-6 lg:col-span-2 lg:mx-0 ">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="mt-4">
                          <p className="text-2xl font-bold text-primary sm:text-3xl">
                            {testimonial.name} {testimonial.lname}
                          </p>
            ...
            <div className="mt-4 md:mt-8 pr-4 pl-4 flex justify-between lg:hidden">
              <button
                aria-label="Previous slide"
